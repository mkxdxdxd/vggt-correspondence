...
def postprocess_fn(sample):
    ...
    for i in range(12):
        img = tensor_transform(decode_image(sample[f"png_{i:03}"], color_background))
        save_image(img, f"/mnt/image-net-full/j1nhwa.kim/interns/minseop.kwak/multiview-gen/genwarp/duster_try/img_{i}.png")
        img_data.append(img)
